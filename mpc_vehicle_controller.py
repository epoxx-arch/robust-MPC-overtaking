...
Model Predictive Control (MPC) is used to control a vehicle model along the previously generated reference trajectory.
This model assumes the kinematic bicycle model and uses data generated by the "cftoc_trajectory_generator.ipynb" script.
"""
